...
def from_nfg(game, num_players, num_actions, num_objectives, batch_size=1, **kwargs):
    ...
    generated by adding a new dimension to the payoff matrices. Multi-objective versions of these games ensure that the
    payoffs for each objective individually follow the same distribution.
